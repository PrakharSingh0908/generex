...
My Idea:
Create a perfect working generative shader and art creator for my modern non-conventional design studio, don't start building the features until I tell you to develop that particular. You can see how modern studios are using generative tools to create branding for new modern tech brands
